package com.gohool.covr.musicplayer;
...
public class MainActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                int curentPos = mediaPlayer.getCurrentPosition();
                int duration = mediaPlayer.getDuration();


                leftTime.setText(dateFormat.format(new Date(curentPos)));

                rightTime.setText(dateFormat.format(new Date(duration - curentPos)));
    ...
    public void setUpUI() {
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.roc_marci_76_instrumental);
